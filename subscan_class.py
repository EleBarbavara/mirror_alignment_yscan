...
class Subscan():
    ...
    def __init__(self, cfg, mode='SRT'):
        ...
        if cfg['paths']['offset_pixel']!=False:
            ...
            self.dati_beammap = pd.DataFrame(dati, columns=['id', 'lon-offset', 'lat-offset', 'Tcal pol1', 'Tcal pol2', 'flag']) #flag: 0=>ok, 1=>bad
    ...
    def extract_data(self, filename, config):
        ...
        if self.mode == 'SRT':
            ...
            self.name_schedule = hdul['PRIMARY'].header['HIERARCH ScheduleName']
